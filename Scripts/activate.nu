...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\STRIX\pythonProject\Color_Palette_Explorer'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\STRIX\pythonProject\Color_Palette_Explorer\Scripts\deactivate.nu'
